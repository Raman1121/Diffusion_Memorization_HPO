...
from svdiff.diffusers_models.attention import AdaGroupNorm
...
class Upsample2D(nn.Module):
    ...
    def __init__(
        ...
        if use_conv_transpose:
            ...
            conv = SVDConv2d(self.channels, self.out_channels, 3, padding=1)
        ...
        *,
        ...
        if temb_channels is not None:
            if self.time_embedding_norm == "default":
                ...
                self.time_emb_proj = SVDLinear(temb_channels, 2 * out_channels)
